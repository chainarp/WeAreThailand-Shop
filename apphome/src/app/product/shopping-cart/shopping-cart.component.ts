...
export class ShoppingCartComponent implements OnInit {
    ...
    public isCartContainedThing(): boolean {
        //console.log("isCartContainedThing() this.cartServiceProvider.shoppingCart.cartElements.length="+this.cartServiceProvider.shoppingCart.cartElements.length);
        return this.cartServiceProvider.shoppingCart.cartElements.length == 0 ? false : true;
    }
